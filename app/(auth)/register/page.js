    ...
    <div className="auth-background min-h-screen flex items-center justify-center p-4 relative">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="text-white/90 block mb-2 text-sm font-medium">Email (Optional)</label>
            <input
              type="email"
              name="email"
          ...
          <div>
            <label className="text-white/90 block mb-2 text-sm font-medium">Confirm Password</label>
            <input
              type="password"
          ...
          <p className="text-center text-white/90">
            ...
            <a href="/login" className="text-white hover:text-blue-200 font-medium">
              Login Here
            </a>
          </p>
        </form>
